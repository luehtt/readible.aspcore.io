...
## How to run
  ...
  3. cd to app folder  
  4. make sure all NuGet package loaded
  5. run `dotnet watch run` or `dotnet run`
  6. go to address `https://localhost:5001/api/migrate`  
  7. go to address `https://localhost:5001/api/seed` (optional)  
